 ...
 */
final class Version20240708055149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_parameter_value (post_id UUID NOT NULL, parameter_id VARCHAR(255) NOT NULL, PRIMARY KEY(post_id, parameter_id))');
        $this->addSql('CREATE INDEX IDX_208462D04B89032C ON post_parameter_value (post_id)');
        $this->addSql('CREATE INDEX IDX_208462D07C56DBD6 ON post_parameter_value (parameter_id)');
        ...
        $this->addSql('ALTER TABLE post_parameter_value ADD CONSTRAINT FK_208462D07C56DBD6 FOREIGN KEY (parameter_id) REFERENCES parameter (name) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_parameter_value DROP CONSTRAINT FK_208462D07C56DBD6');
