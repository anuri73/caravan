 ...
 */
final class Version20240719191224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id UUID NOT NULL, author_id UUID NOT NULL, category_name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5A8A6C8DF675F31B ON post (author_id)');
        $this->addSql('CREATE INDEX IDX_5A8A6C8DD5B80441 ON post (category_name)');
        ...
        $this->addSql('CREATE TABLE post_parameter_value (id UUID NOT NULL, post_id UUID NOT NULL, parameter_name VARCHAR(255) NOT NULL, category_name VARCHAR(255) NOT NULL, value VARCHAR(1024) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_208462D04B89032C ON post_parameter_value (post_id)');
        $this->addSql('CREATE INDEX IDX_208462D0F12D7D03D5B80441 ON post_parameter_value (parameter_name, category_name)');
        $this->addSql('CREATE UNIQUE INDEX idx_parameter_value ON post_parameter_value (post_id, parameter_name, category_name)');
        $this->addSql('COMMENT ON COLUMN post_parameter_value.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN post_parameter_value.post_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE "user" (id UUID NOT NULL, email VARCHAR(512) NOT NULL, password_hash VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8DD5B80441 FOREIGN KEY (category_name) REFERENCES category (name) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE post_parameter_value ADD CONSTRAINT FK_208462D0F12D7D03D5B80441 FOREIGN KEY (parameter_name, category_name) REFERENCES parameter (name, category_name) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP CONSTRAINT FK_5A8A6C8DD5B80441');
        $this->addSql('ALTER TABLE post_parameter_value DROP CONSTRAINT FK_208462D04B89032C');
        $this->addSql('ALTER TABLE post_parameter_value DROP CONSTRAINT FK_208462D0F12D7D03D5B80441');
